...
- **รันฐานข้อมูลอัตโนมัติ (`setup-db.js`):** ระบบจะอ่านไฟล์จากโฟลเดอร์ `Table/`, `Table/Procedures/` และ `Data/` แล้วนำไปสร้างตารางพร้อมใส่ข้อมูลตัวอย่าง (Mock Data) ลง Database ให้อัตโนมัติ (ไม่ต้องเปิด DBeaver มารัน SQL เอง!)
